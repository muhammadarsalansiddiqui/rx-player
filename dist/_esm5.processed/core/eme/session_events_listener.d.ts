...
import { IBlacklistKeysEvent, IEMEWarningEvent, IKeySystemOption, ISessionUpdatedEvent } from "./types";
/**
 ...
 * @returns {Observable}
 */
export default function SessionEventsListener(session: MediaKeySession | ICustomMediaKeySession, keySystem: IKeySystemOption): Observable<ISessionUpdatedEvent | IBlacklistKeysEvent | IEMEWarningEvent>;
